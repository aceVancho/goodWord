...
export const prompts = {
  searchThesaurus: (term: string, level: string) => ([new SystemMessage(`
  ...
  `)]),
  cleanThesaurusResults: (term: string, results: string[]) => ([new HumanMessage(`
  ...
  `)]),
  categorizeThesaurusResults: (term: string, results: string[]) => ([new HumanMessage(`
